...
from laakhay.ta.core.types import (
    Price, Qty, Rate, Symbol, Timestamp,
    PriceLike, QtyLike, RateLike, TimestampLike
)
...
class TestTypes:
    ...
    def test_type_operations(self, sample_prices: Dict[str, Union[int, float, str, Decimal]], sample_quantities: Dict[str, Union[int, float, str, Decimal]], sample_rates: Dict[str, Union[int, float, str, Decimal]]) -> None:
