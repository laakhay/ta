...
class TestCoercers:
    ...
    def test_coerce_price(self, sample_prices: Dict[str, Union[int, float, str, Decimal]]) -> None:
    ...
    def test_coerce_qty(self, sample_quantities: Dict[str, Union[int, float, str, Decimal]]) -> None:
    ...
    def test_coerce_rate(self, sample_rates: Dict[str, Union[int, float, str, Decimal]]) -> None:
