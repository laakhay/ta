...
class TestMACDIndicator:
    ...
    def test_macd_basic_calculation(self):
        ...
        timestamps = [datetime(2024, 1, i, tzinfo=timezone.utc) for i in range(1, 31)]  # 30 days
    ...
    def test_macd_metadata_inheritance(self):
        ...
        timestamps = [datetime(2024, 1, i, tzinfo=timezone.utc) for i in range(1, 31)]
    ...
    def test_macd_short_series(self):
        ...
        timestamps = [datetime(2024, 1, i, tzinfo=timezone.utc) for i in range(1, 21)]  # 20 days
