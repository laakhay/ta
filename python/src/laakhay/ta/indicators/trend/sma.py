...
SMA_SPEC = IndicatorSpec(
    name="sma",
    description="Simple Moving Average over a price series",
    inputs=(
        InputSlotSpec(
            name="input_series",
    ...
    outputs={"result": OutputSpec(name="result", type=Series, description="SMA values", role="line")},
